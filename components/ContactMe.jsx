    ...
    return (
        <div className="flex-col justify-center align-center">
            ...
            <div className="flex justify-center align-center" style={{ marginTop: "10vw" }}>
                <h2 className="contactEmail baltica text-center text-white" style={{ fontSize: "3vw" }}>
                    Email:&nbsp;
                </h2>
                <a href="mailto: Duncan.C.Payne@gmail.com" className="contactEmail baltica text-center text-white underline" style={{ fontSize: "3vw" }}>
